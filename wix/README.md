...
1. Windows Installer XML (WiX) toolset, 3.11 or later, [http://wixtoolset.org/releases/](http://wixtoolset.org/releases/)
...
```batch
call powershell.exe ./CreateSourceFolder.Adoptium.ps1
```
...
- FeatureOracleJavaSoft can't and must not be used per user install as it only write to HKLM. (see [Oracle Docs](https://docs.oracle.com/javase/9/install/installation-jdk-and-jre-microsoft-windows-platforms.htm#JSJIG-GUID-47C269A3-5220-412F-9E31-4B8C37A82BFB)
...
See [https://docs.microsoft.com/fr-fr/windows/desktop/Msi/allusers](https://docs.microsoft.com/fr-fr/windows/desktop/Msi/allusers)
...
CF [https://docs.microsoft.com/en-us/windows/desktop/msi/reinstallmode](https://docs.microsoft.com/en-us/windows/desktop/msi/reinstallmode)
...
Upgradable MSI work only for first 3 digit from the build number (due to MSI limitation ):  [https://docs.microsoft.com/fr-fr/windows/desktop/Msi/productversion](https://docs.microsoft.com/fr-fr/windows/desktop/Msi/productversion)
...
- Upgradable : 8.0.2.1 -> 11.0.2.1 No  ( Adoptium doesn't provide upgrade for different major version ( jdk 8 -> jdk 11 ) (You can keep both or uninstall older jdk yourself )
