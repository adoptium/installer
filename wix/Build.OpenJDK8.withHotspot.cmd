...
SET PRODUCT_MAINTENANCE_VERSION=172
SET PRODUCT_PATCH_VERSION=11
...
FOR %%G IN (x64) DO (
  ...
  FOR %%H IN (withHotspot) DO (
    ...
    SET OUTPUT_BASE_FILENAME=!PRODUCT_SKU!!PRODUCT_MAJOR_VERSION!.!PACKAGE_TYPE!.!PLATFORM!.!PRODUCT_VERSION!
