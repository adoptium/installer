%global upstream_version 8u282-b08
# Only [A-Za-z0-9.] allowed in version:
# https://docs.fedoraproject.org/en-US/packaging-guidelines/Versioning/#_upstream_uses_invalid_characters_in_the_version
# also not very intuitive:
#  $ rpmdev-vercmp 11.0.10.0.1___9 11.0.10.0.0+9
#  11.0.10.0.0___9 == 11.0.10.0.0+9
%global spec_version 1.8.0.282.08
%global spec_release 1
%global priority 1110

%global source_url_base https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/
...
Name:        java-1.8.0-openj9
Version:     %{spec_version}
Release:     %{spec_release}%{?dist}
Summary:     OpenJ9 8 JDK
...
#https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u282-b08_openj9-0.24.0/OpenJDK8U-jdk_ppc64le_linux_openj9_8u282b08_openj9-0.24.0.tar.gz
Source0: %{source_url_base}/jdk%{upstream_version}%{openj9_url_version}/OpenJDK8U-jdk_%{vers_arch}_linux_%{jvm_type}_%{upstream_version_no_dash}%{openj9_url_version}.tar.gz
Source1: %{source_url_base}/jdk%{upstream_version}%{openj9_url_version}/OpenJDK8U-jdk_%{vers_arch}_linux_%{jvm_type}_%{upstream_version_no_dash}%{openj9_url_version}.tar.gz.sha256.txt
# Second architecture (ppc64le)
Source2: %{source_url_base}/jdk%{upstream_version}%{openj9_url_version}/OpenJDK8U-jdk_%{vers_arch2}_linux_%{jvm_type}_%{upstream_version_no_dash}%{openj9_url_version}.tar.gz
Source3: %{source_url_base}/jdk%{upstream_version}%{openj9_url_version}/OpenJDK8U-jdk_%{vers_arch2}_linux_%{jvm_type}_%{upstream_version_no_dash}%{openj9_url_version}.tar.gz.sha256.txt
# Third architecture (s390x)
Source4: %{source_url_base}/jdk%{upstream_version}%{openj9_url_version}/OpenJDK8U-jdk_%{vers_arch3}_linux_%{jvm_type}_%{upstream_version_no_dash}%{openj9_url_version}.tar.gz
Source5: %{source_url_base}/jdk%{upstream_version}%{openj9_url_version}/OpenJDK8U-jdk_%{vers_arch3}_linux_%{jvm_type}_%{upstream_version_no_dash}%{openj9_url_version}.tar.gz.sha256.txt

# For the benefit of the SRPM only
Source100: https://github.com/ibmruntimes/openj9-openjdk-jdk8/archive/jdk%{upstream_version}.tar.gz
