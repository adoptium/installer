...
Summary:     Eclipse Temurin 20 JDK
...
Provides: java
Provides: java-20
Provides: java-20-devel
Provides: java-20-headless
Provides: java-20-%{java_provides}
Provides: java-20-%{java_provides}-devel
Provides: java-20-%{java_provides}-headless
Provides: java-devel
...
Provides: java-sdk
Provides: java-sdk-20
Provides: java-sdk-20-%{java_provides}
Provides: java-sdk-%{java_provides}

# First architecture (x86_64)
Source0: %{source_url_base}/jdk-%{upstream_version_url}/OpenJDK20U-jdk_%{vers_arch}_linux_hotspot_%{upstream_version_no_plus}.tar.gz
Source1: %{source_url_base}/jdk-%{upstream_version_url}/OpenJDK20U-jdk_%{vers_arch}_linux_hotspot_%{upstream_version_no_plus}.tar.gz.sha256.txt
...
%changelog
* Wed Feb 22 2023 Eclipse Adoptium Package Maintainers <temurin-dev@eclipse.org> 20.0.2.0.0.7-2.adopt0
- Eclipse Temurin 20.0.2+7 release 2.
* Wed Jan 18 2023 Eclipse Adoptium Package Maintainers <temurin-dev@eclipse.org> 20.0.2.0.0.7.adopt0
- Eclipse Temurin 20.0.2+7 release.
* Sat Nov 05 2022 Eclipse Adoptium Package Maintainers <temurin-dev@eclipse.org> 20.0.1.0.0.10.adopt0
- Eclipse Temurin 20.0.1+10 release.
* Tue Sep 20 2022 Eclipse Adoptium Package Maintainers <temurin-dev@eclipse.org> 20.0.0.0.0.36-1.adopt0
- Eclipse Temurin 20.0.0+36 release.
