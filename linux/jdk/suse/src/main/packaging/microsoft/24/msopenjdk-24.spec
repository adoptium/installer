%global upstream_version 24.0.1+9
# Only [A-Za-z0-9.] allowed in version:
# https://docs.fedoraproject.org/en-US/packaging-guidelines/Versioning/#_upstream_uses_invalid_characters_in_the_version
# also not very intuitive:
#  $ rpmdev-vercmp 24.0.0.0.0___24.0.0.0.0+1
#  24.0.0.0.0___1 == 24.0.0.0.0+35
%global spec_version 24.0.1
...
Summary:     Microsoft Build of OpenJDK 24
...
%changelog
* Wed Jun 11 2025 Microsoft Package Maintainers <openjdk@microsoft.com> 24.0.1-1
- Microsoft 24.0.1+9 initial release.